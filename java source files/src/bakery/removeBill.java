...
public class removeBill extends javax.swing.JFrame {
    ...
    private void cbo_bNumberItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbo_bNumberItemStateChanged
        if(listLoaded) {
            String sql = "select bNumber, bDate, bCustName, sum(bAmount) from billing where bNumber=? group by bNumber, bDate, bCustName";
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null,"Billing details cannot be found: " + e);
            }finally {
                try{
                    rs.close();
                    pst.close();

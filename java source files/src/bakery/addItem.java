...
public class addItem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(30, 60, 110, 15);
        ...
        jLabel3.setBounds(30, 110, 110, 15);
        ...
        jLabel4.setBounds(30, 160, 110, 15);
        ...
        jLabel5.setBounds(30, 210, 110, 15);
        ...
        jLabel7.setBounds(450, 60, 120, 15);
        ...
        jLabel9.setBounds(450, 110, 120, 15);
        ...
        jLabel8.setBounds(30, 260, 120, 15);

        jLabel10.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        jLabel10.setText("Item amount : ");
        pnl_main.add(jLabel10);
        jLabel10.setBounds(450, 210, 120, 15);
        ...
        jLabel11.setBounds(450, 160, 120, 15);
        ...
        jLabel12.setBounds(30, 310, 110, 15);
    ...
    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_saveActionPerformed
       if (txt_iId.getText().equals("")) {  // Check if item ID is entered
        JOptionPane.showMessageDialog(null, "Please enter the item ID.");
    } else {
        try {
            int itemId = Integer.parseInt(txt_iId.getText());
            int orderQuantity = Integer.parseInt(txt_bQty.getText());
            
            // Step 1: Check Inventory Quantity
            String checkInventorySql = "SELECT inQty FROM inventory WHERE item_iId = ?";
            pst = conn.prepareStatement(checkInventorySql);
            pst.setInt(1, itemId);
            rs = pst.executeQuery();
            
            if (rs.next()) {
                int availableQuantity = rs.getInt("inQty");
            ...
            // Step 2: Insert Order into Billing Table
            String insertBillingSql = "INSERT INTO billing " 
                            + "(bNumber, bDate, bCustName, item_iId, iName, iDescription, bQty, iSp, iCp) VALUES (?,?,?,?,?,?,?,?,?)";
            pst = conn.prepareStatement(insertBillingSql);
            ...
            String updateInventorySql = "UPDATE inventory SET inQty = inQty - ? WHERE item_iId = ?";
            pst = conn.prepareStatement(updateInventorySql);
            pst.setInt(1, orderQuantity);
            pst.setInt(2, itemId);
            pst.executeUpdate();
